...
class FixMahGemfile
  ...
  def self.usage
    puts "Usage: #{$0} [--help] [--generate_rc] [path/to/rc_file]"
    puts "Where:"
    puts "   --help : this help"
...
FixMahGemfile.run "bundle"
#FixMahGemfile.run "bundle update libxml-ruby"
#FixMahGemfile.run "bundle update guard guard-less therubyracer"
END
  end
  def self.run str
    puts str
